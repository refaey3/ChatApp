...
export default function Userinfo() {
  ...
  const handleUpdateName = async () => {
    ...
    try {
      ...
      const myChatsRef = collection(db, "userChats", me.uid, "chats");
      const myChatsSnap = await getDocs(myChatsRef);
      const updatePromises = [];

      myChatsSnap.forEach((chatDoc) => {
        ...
        updatePromises.push(updateDoc(friendChatRef, { username: newName }));
      });
